...
func GetCurrResult(network *network.NetworkInfo, endpoint *network.EndpointInfo, ifname string, cniConfig *NetworkConfig) cniTypes040.Result {
	result := cniTypes040.Result{
		IPs:    []*cniTypes040.IPConfig{},
